        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <form className="flex max-w-sm" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="bg-customPurple hover:bg-customPurple-hover text-white text-sm px-4 py-2 font-medium transition border border-transparent focus:outline-none rounded-full"
              >
                Join
              </button>
            </form>
