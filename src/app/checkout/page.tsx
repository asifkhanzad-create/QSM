    ...
    return (
      <>
        <main className="flex-1 bg-stone-50/50 py-16 sm:py-24 px-4 flex items-center justify-center">
          <div className="max-w-md w-full bg-white border border-neutral-100 rounded-3xl shadow-xl p-8 text-center space-y-6 animate-scale-in">
    ...
    <>
      <main className="flex-1 bg-stone-50/50">
        <div className="max-w-[1200px] mx-auto py-8 sm:py-12">
          <div className="md:bg-white md:rounded-[32px] md:shadow-[0_2px_20px_rgba(0,0,0,0.08)] md:border md:border-neutral-100/80 md:px-8 md:py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start px-4 sm:px-6 md:px-0">
              ...
              <div className="lg:col-span-7 space-y-6">
                <form onSubmit={handlePlaceOrder} className="space-y-6">
                  ...
                  {/* Customer Info */}
                  <div className="bg-white md:bg-neutral-50/50 rounded-3xl border border-neutral-100 md:border-neutral-200/60 shadow-sm md:shadow-none p-6 space-y-4">
              ...
              <div className="lg:col-span-5 bg-white md:bg-neutral-50/50 border border-neutral-100 md:border-neutral-200/60 rounded-3xl shadow-sm md:shadow-none p-6 space-y-6">
      ...
      {showConfirmDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 animate-fade-in">
          <div className="max-w-sm w-full bg-white rounded-3xl shadow-xl p-7 text-center space-y-5 animate-scale-in">
